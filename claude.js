...
CAMPOS REQUERIDOS:
{
  ...
  "dias_facturacion": número de días del periodo facturado. CALCULA la diferencia en días entre la fecha de inicio y fin del período que aparece en la cabecera de la factura (ej: "01/01/2026 - 10/02/2026" = 40 días). NUNCA uses el número que aparece en la expresión "x N días" dentro del desglose de potencia o energía — ese es un subperíodo de cálculo, no el período total facturado,
